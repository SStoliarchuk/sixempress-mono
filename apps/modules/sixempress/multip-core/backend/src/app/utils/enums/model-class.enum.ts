...
export enum ModelClass {
	...
	ExternalSyncTrackStat = 'ExternalSyncTrackStatModel',
	ExternalSyncLockTrack = 'ExternalSyncLockTrackModel',
	ExternalSyncProcessTrack = 'ExternalSyncProcessTrackModel',
}
