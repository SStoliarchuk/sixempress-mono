...
export interface ICategoriesTreeItem extends InventoryCategory {
	__jsx_children?: JSX.Element[];
	__jsx?: JSX.Element;
}

export interface IICLState {
	catIdHm?: {[id: string]: ICategoriesTreeItem};
...
export interface IICLProps {
	selectCategoryMode?: {
		selectFn: (cat: InventoryCategory) => void
	};
}
