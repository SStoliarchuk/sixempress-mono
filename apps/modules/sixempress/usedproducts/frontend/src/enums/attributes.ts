...
export const AttributeLabel = {
	[Attribute.viewUsedProducts]   : 'Visualizzare Prodotti Usati',
	[Attribute.addUsedProducts]    : 'Aggiungere Prodotti Usati',
	[Attribute.modifyUsedProducts] : 'Modificare Prodotti Usati',
	[Attribute.deleteUsedProducts] : 'Eliminare Prodotti Usati',
